...
- [x] 3. Update database schema for seasonal attributes
  - [x] 3.1 Update create_schema.py to add seasonal columns to games table
  ...
  - [x] 3.2 Update sql_manager.py insert methods
  ...
  - [x] 3.3 Update sql_manager.py query methods
...
- [x] 4. Update generator to read and apply seasonal tags
  - [x] 4.1 Read seasonal text files after completion marking
  ...
  - [x] 4.2 Apply seasonal tags to GameObjects
...
- [x] 5. Create sample seasonal text files
...
- [x] 6. Verify exports include seasonal data
